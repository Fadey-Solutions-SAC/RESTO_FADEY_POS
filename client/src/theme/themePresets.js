...
export const THEME_PRESETS = {
  ...
  emerald_business: preset(
    ...
    ['cadena', 'corporativo'],
    {
      ...
      '--ui-surface': '#ffffff',
      '--ui-surface-2': '#ecfdf5',
      '--ui-border': 'rgba(6, 78, 59, 0.22)',
      '--ui-accent': '#064e3b',
      '--ui-accent-hover': '#022c22',
      '--ui-accent-muted': '#047857',
      '--ui-input-bg': '#ffffff',
      '--ui-input-border': 'rgba(6, 78, 59, 0.28)',
      '--ui-focus-ring': '#047857',
      '--ui-sidebar-active-bg': 'rgba(4, 120, 87, 0.22)',
  ...
  purple: preset(
    ...
    ['legacy'],
    {
      ...
      '--ui-surface': '#17182A',
      '--ui-surface-2': '#1E1E36',
      '--ui-border': 'rgba(90, 78, 239, 0.28)',
      '--ui-accent': '#5A4EEF',
      '--ui-accent-hover': '#4C40D9',
      '--ui-accent-muted': '#7C75F5',
      '--ui-input-bg': '#17182A',
      ...
      '--ui-logo-to': '#5A4EEF',
      '--ui-btn-secondary-hover': 'rgba(255, 255, 255, 0.08)',
      '--ui-glass': 'rgba(23, 24, 42, 0.92)',
    },
    ['#5A4EEF', '#34d399', '#fbbf24', '#f87171', '#a78bfa', '#38bdf8'],
    'dark'
  ),
